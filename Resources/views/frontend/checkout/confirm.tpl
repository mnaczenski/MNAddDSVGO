    ...
    {elseif $DSVGO.addCheckout == 'checkbox' }
        <li class="block-group row--tos">
            ...
            <span class="block column--label">
                <label for="checkoutcheckbox" data-modalbox="true" data-targetSelector="a" data-mode="ajax" data-height="500" data-width="750">{s name="DSVGOPrivacy" namespace="frontend/DSVGO/"}Die <a title="Datenschutzbestimmungen" href="{url controller=custom sCustom=7}">Datenschutzbestimmungen</a> habe ich zur Kenntnis genommen{/s}</label>
            </span>
        </li>
    {/if}
    {$smarty.block.parent}
